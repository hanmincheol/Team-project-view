...
declare module '@vue/runtime-core' {
  export interface GlobalComponents {
    ...
    Register: typeof import('./src/views/demos/register/register.vue')['default']
    ...
    TestPage: typeof import('./src/views/demos/register/TestPage.vue')['default']
    TestTest: typeof import('./src/views/demos/register/TestTest.vue')['default']
