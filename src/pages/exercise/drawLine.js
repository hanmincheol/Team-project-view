...
var drawingFlag = ref(false) // 선이 그려지고 있는 상태를 가지고 있을 변수입니다
var moveLine = ref(null) // 선이 그려지고 있을때 마우스 움직임에 따라 그려질 선 객체 입니다
var clickLine = ref(null) // 마우스로 클릭한 좌표로 그려질 선 객체입니다
