<template>
    <div
        ...
        @click="$emit('refreshChildRoad', lat[0], lng[0], this.drawingMap)"
    />
</template>
<script>
    import { ref } from 'vue';
...
<style>
.dot {overflow:hidden;float:left;width:12px;height:12px;background: url('http://localhost:3333/src/assets/images/mapPoint.svg');}    
.dotOverlay {position:relative;bottom:10px;border-radius:6px;border: 1px solid #ccc;border-bottom:2px solid #ddd;float:left;font-size:12px;padding:5px;background:#fff;}
.dotOverlay:nth-of-type(n) {border:0; box-shadow:0px 1px 2px #888;}    
.number {font-weight:bold;color:#005D32;}
