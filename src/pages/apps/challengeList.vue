          ...
          <VCard>
            ...
            <VCardText>
              ...
              <div class="d-flex align-center justify-space-between flex-wrap text-xs mt-4 mb-2">
                ...
                <span style="font-weight: bold;">
                  {{ challenge.participantsData.reduce((sum, currentValue) => sum + currentValue.CHALL_IMPLEMENTATION_RATE, 0) / getHourDifference(new Date(challenge.cendDate), new Date(challenge.cstartDate))/24*3*challenge.participantsData.length }}% 달성
                </span>
              </div>
              ...
              <VProgressLinear
                ...
                rounded-bar
                height="8"
                :model-value="challenge.participantsData.reduce((sum, currentValue) => sum + currentValue.CHALL_IMPLEMENTATION_RATE, 0) / getHourDifference(new Date(challenge.cendDate), new Date(challenge.cstartDate))/24*3*challenge.participantsData.length"
                :max="100"
                color="primary"
              />
