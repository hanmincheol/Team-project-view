...
const goal_No = ref([
  { state: '건강 관리', value: '건강 관리' },
  { state: '체중 감량', value: '체중 감량' },
  { state: '체중 증가', value: '체중 증가' },
  { state: '근육 강화', value: '근육 강화' },
  { state: '다이어트 식단', value: '다이어트 식단' },
])
...
function handleSelect(value) {
  ...
  emit('update:modelValue', value)  // gender의 값을 부모 컴포넌트로 넘김
  console.log(newGoalNo)
}
